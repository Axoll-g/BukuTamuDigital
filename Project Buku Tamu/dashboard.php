...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['ajax'])) {
    ...
    if (isset($_POST['nama'], $_POST['email'], $_POST['komentar'])) {
        ...
        $stmt = $conn->prepare("INSERT INTO comments (waktu, nama, email, komentar) VALUES (?, ?, ?, ?)");
...
if (isset($_GET['action']) && $_GET['action'] === 'loadEntries') {
    $entries = [];
    $result = $conn->query("SELECT waktu, nama, email, komentar FROM comments ORDER BY waktu DESC");
